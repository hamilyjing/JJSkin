...
- (instancetype)initWithSkinConfig:(id<JJSkinConfig>)skinConfig;

// You should invoke "remove..." function to clean no used memory. Or init a skin manager, it will remove memory when dealloc.
